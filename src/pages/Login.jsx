...
const Login = () => {
    ...
    return (
        <div className='bg-primary'>
            <title>Login - Rent Wheel</title>
            <div className="hero bg-linear-to-bl from-orange-100 to-white p-15">
                <div className="hero-content flex-col">
                    <div className="text-center lg:text-left">
                        <h1 className="text-4xl font-bold mb-5 text-secondary">Login now!</h1>
                    </div>
                    <div className="card bg-base-100 w-full max-w-sm shrink-0 shadow-2xl">
                        <div className="card-body">
                            ...
                            <div className='mt-3'><p>New to Rent Wheel? <Link to='/register' className='link link-hover text-primary'>Register</Link> </p></div>
                        </div>
                    </div>
                </div>
            </div>
