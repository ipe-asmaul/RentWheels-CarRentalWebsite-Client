...
const Testimonials = () => {
    return (
        <div>
            ...
            <div className="badge-testimoy absolute top-0 right-0 h-5/10 w-50 bg-radial-[at_25%_75%] from-primary to-accent rounded-bl-full -z-10 opacity-80"></div>
            ...
            <div className="badge-testimoy absolute bottom-0 left-0 h-5/10 w-50 bg-radial-[at_25%_75%] from-primary to-accent rounded-tr-full -z-10 opacity-80"></div>
